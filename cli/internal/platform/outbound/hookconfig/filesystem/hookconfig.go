...
func NewFilesystemHookConfig(l *slog.Logger, authPath string) hookconfig.HookConfigPort {
...
// LoadAuthConfig loads API key configuration from auth.json.

...
func NewKardianosInstaller(l *slog.Logger, binaryPath string) *KardianosInstaller {
...
func (i *KardianosInstaller) Install(ctx context.Context) error {
	...
	i.logger.Info("daemon service installed successfully",
		slog.String("binary", i.binaryPath))
	return nil
}
...
func (i *KardianosInstaller) createService() (service.Service, error) {
	binaryPath, err := pathutil.ExpandPath(i.binaryPath)
	if err != nil {

 ...
 */
export const file_aggregation_v1_aggregation: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
...
export type UserMessageBlockContentSource =
  Message<'aggregation.v1.UserMessageBlockContentSource'> & {
    /**
...
export type UserMessageBlockContentToolResult =
  Message<'aggregation.v1.UserMessageBlockContentToolResult'> & {
    /**
...
export type UserMessageBlockContent =
  Message<'aggregation.v1.UserMessageBlockContent'> & {
    /**
     * @generated from field: string type = 1;
     */
    type: string
...
export type UserMessageBlockContentList =
  Message<'aggregation.v1.UserMessageBlockContentList'> & {
    /**
...
export type UserRecordThinkingMetadataTrigger =
  Message<'aggregation.v1.UserRecordThinkingMetadataTrigger'> & {
    /**
...
export type UserRecordThinkingMetadata =
  Message<'aggregation.v1.UserRecordThinkingMetadata'> & {
    /**
...
export type AssistantMessageContent =
  Message<'aggregation.v1.AssistantMessageContent'> & {
    /**
     * @generated from field: string type = 1;
     */
    type: string
...
export type AssistantMessageUsage =
  Message<'aggregation.v1.AssistantMessageUsage'> & {
    /**
 ...
 */
export type AssistantRecordData =
  Message<'aggregation.v1.AssistantRecordData'> & {
    /**
     * @generated from field: aggregation.v1.MessageMetadata metadata = 1;
     */
    metadata?: MessageMetadata
...
export type FileHistorySnapshotTrackedBackup =
  Message<'aggregation.v1.FileHistorySnapshotTrackedBackup'> & {
    /**
...
export type FileHistorySnapshot =
  Message<'aggregation.v1.FileHistorySnapshot'> & {
    /**
...
export type FileHistorySnapshotRecordData =
  Message<'aggregation.v1.FileHistorySnapshotRecordData'> & {
    /**
     * @generated from field: string message_id = 1;
     */
    messageId: string
...
}> = /*@__PURE__*/ serviceDesc(file_aggregation_v1_aggregation, 0)

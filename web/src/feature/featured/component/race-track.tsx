  ...
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      <g className={idle ? '' : 'homer-arm-back'}>
        <path d="M18 28 L10 34 L7 38" stroke="#E5E7EB" strokeWidth="4" strokeLinecap="round" fill="none" />
      </g>
      ...
      <path d="M16 22 Q22 24 28 22" stroke="#E5E7EB" strokeWidth="1.5" fill="none" />
      ...
      <g className={idle ? '' : 'homer-arm-front'}>
        <path d="M26 26 L34 31 L37 35" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" fill="none" />
      ...
      <path d="M24 18 Q30 16 34 18" stroke="#1C1917" strokeWidth="1" fill="none" />
      <path d="M25 20 Q29 22 33 20" stroke="#D97706" strokeWidth="1" fill="none" />
      ...
      <path d="M22 8 Q26 6 30 8" stroke="#1C1917" strokeWidth="1.2" fill="none" />
      <path d="M18 4 Q17 1 19 0" stroke="#1C1917" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      <path d="M21 3 Q20 0 22 -1" stroke="#1C1917" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      <path d="M24 3 Q24 0 26 -1" stroke="#1C1917" strokeWidth="1.5" strokeLinecap="round" fill="none" />
    </svg>
  )
}
...
function BartCharacter({ idle }: CharacterProps) {
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      ...
      <ellipse cx="18" cy="23" rx="2.2" ry="2.5" fill="#FBBF24" stroke="#d97706" strokeWidth="0.4" />
      <circle cx="32" cy="21" r="3.2" fill="white" />
      <circle cx="33" cy="21.5" r="1.8" fill="#1a1a1a" />
      <circle cx="33.6" cy="20.8" r="0.6" fill="white" />
      <path d="M29,19.5 Q32,17.5 35.2,19.5" stroke="#1a1a1a" strokeWidth="1.1" fill="none" strokeLinecap="round" />
      <path d="M29,17.5 Q32,15.5 35,17" stroke="#1a1a1a" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      <path d="M35,23 Q38,22 37,25 Q36,26 35,25" fill="#FBBF24" stroke="#d97706" strokeWidth="0.5" />
      <path d="M30,28 Q33,30 35,27" stroke="#1a1a1a" strokeWidth="1" fill="none" strokeLinecap="round" />
      <rect x="22" y="30" width="7" height="4" fill="#FBBF24" />
      <path d="M16,34 Q14,34 14,42 L34,42 Q34,34 32,34 L28,34 Q28,32 25,32 Q22,32 22,34 Z" fill="#EF4444" />
      ...
      <g className={idle ? '' : 'bart-arm-back'}>
        <line x1="15" y1="36" x2="10" y2="44" stroke="#FBBF24" strokeWidth="3.5" strokeLinecap="round" />
        <circle cx="10" cy="44.5" r="2.2" fill="#FBBF24" />
      </g>
      <g className={idle ? '' : 'bart-arm-front'}>
        <line x1="33" y1="36" x2="38" y2="44" stroke="#FBBF24" strokeWidth="3.5" strokeLinecap="round" />
        <circle cx="38" cy="44.5" r="2.2" fill="#FBBF24" />
      </g>
      <path d="M14,42 L14,48 L22,48 L24,43 L26,48 L34,48 L34,42 Z" fill="#3B82F6" />
      <g className={idle ? '' : 'bart-leg-back'}>
        <line x1="19" y1="48" x2="17" y2="52" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" />
      ...
      <g className={idle ? '' : 'bart-leg-front'}>
        <line x1="29" y1="48" x2="31" y2="52" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" />
...
function LisaCharacter({ idle }: CharacterProps) {
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      ...
      <path d="M27 17 L34 16.5" stroke="#D97706" strokeWidth="1.4" strokeLinecap="round" />
      <circle cx="34" cy="22" r="1" fill="#E0A010" />
      <path d="M30 26 Q33 28 35 26" stroke="#92400E" strokeWidth="1.1" fill="none" strokeLinecap="round" />
      <circle cx="20" cy="31" r="1.2" fill="white" stroke="#D1D5DB" strokeWidth="0.3" />
      <circle cx="22.5" cy="30" r="1.2" fill="white" stroke="#D1D5DB" strokeWidth="0.3" />
      <circle cx="25" cy="29.5" r="1.2" fill="white" stroke="#D1D5DB" strokeWidth="0.3" />
      <circle cx="27.5" cy="30" r="1.2" fill="white" stroke="#D1D5DB" strokeWidth="0.3" />
      <circle cx="30" cy="31" r="1.2" fill="white" stroke="#D1D5DB" strokeWidth="0.3" />
      <g className={idle ? '' : 'lisa-arm-back'}>
        <path d="M19 34 L10 38 L8 43" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" fill="none" />
      ...
      <g className={idle ? '' : 'lisa-arm-front'}>
        <path d="M30 34 L38 30 L41 26" stroke="#F5C030" strokeWidth="4" strokeLinecap="round" fill="none" />
...
function MargeCharacter({ idle }: CharacterProps) {
  return (
    <svg width="48" height="60" viewBox="0 0 48 60" fill="none">
      ...
      <rect x="16" y="4" width="5" height="16" rx="3" fill="#60A5FA" opacity="0.45" />
      ...
      <path d="M27 21.5 Q29 20 31 21" stroke="#1E293B" strokeWidth="1" fill="none" strokeLinecap="round" />
      <path d="M33 27 Q36 26 35 29" stroke="#F59E0B" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      <path d="M30 31 Q33 33 35 31" stroke="#92400E" strokeWidth="1.1" fill="none" strokeLinecap="round" />
      ...
      <path d="M14 36 Q14 28 24 28 Q34 28 34 36 L36 56 L12 56 Z" fill="#22C55E" />
      <path d="M16 36 Q17 30 22 29" stroke="#4ADE80" strokeWidth="1.2" fill="none" strokeLinecap="round" opacity="0.6" />
      <g className={idle ? '' : 'marge-arm-back'}>
        <path d="M17 37 L10 43 L7 49" stroke="#22C55E" strokeWidth="4" strokeLinecap="round" fill="none" />
      ...
      <g className={idle ? '' : 'marge-arm-front'}>
        <path d="M28 37 L36 42 L39 46" stroke="#16A34A" strokeWidth="4" strokeLinecap="round" fill="none" />
  ...
  return (
    <svg width="40" height="52" viewBox="0 0 40 52" fill="none">
      ...
      <g className={idle ? '' : 'maggie-arm-back'}>
        <path d="M12 30 L5 35 L3 38" stroke="#3B82F6" strokeWidth="5" strokeLinecap="round" fill="none" />
      ...
      <g className={idle ? '' : 'maggie-arm-front'}>
        <path d="M26 29 L33 33 L35 36" stroke="#2563EB" strokeWidth="5" strokeLinecap="round" fill="none" />
        <circle cx="35" cy="36" r="2.8" fill="#FBBF24" />
      </g>
      <circle cx="22" cy="14" r="12" fill="#FBBF24" />
      <ellipse cx="10" cy="14" rx="2.2" ry="2.8" fill="#F5C040" />
      <path d="M14 5 L16 0 L18 4 L20 -1 L22 3 L24 -2 L26 2 L28 -1 L29 4 L31 1 L31 6 L14 6Z" fill="#FBBF24" />
      ...
      <path d="M24 10 Q26 8.5 29 10" stroke="#1E293B" strokeWidth="1" fill="none" strokeLinecap="round" />
      <path d="M24.5 9 Q27 7.5 30 9" stroke="#D97706" strokeWidth="1.2" fill="none" strokeLinecap="round" />
      ...
      <circle cx="33" cy="20" r="1.2" fill="none" stroke="#C2410C" strokeWidth="0.8" />
    </svg>
  )
}
...
function NedCharacter({ idle }: CharacterProps) {
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      ...
      <path d="M16 24 Q20 28 24 24" stroke="#16A34A" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <line x1="10" y1="32" x2="30" y2="32" stroke="#16A34A" strokeWidth="0.8" opacity="0.5" />
      <line x1="10" y1="36" x2="30" y2="36" stroke="#16A34A" strokeWidth="0.8" opacity="0.5" />
      ...
      <path d="M12 8 Q13 1 22 1 Q31 1 32 8 Q30 5 22 5 Q16 5 12 8Z" fill="#78350F" />
      <path d="M16 5 Q19 3.5 22 5" stroke="#92400E" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <ellipse cx="12" cy="11" rx="2" ry="2.5" fill="#F5C518" />
      <line x1="25" y1="11" x2="28" y2="11" stroke="#374151" strokeWidth="1" strokeLinecap="round" />
      <circle cx="30" cy="11" r="3.2" stroke="#374151" strokeWidth="1.2" fill="white" fillOpacity="0.15" />
      <circle cx="23.5" cy="11" r="2.5" stroke="#374151" strokeWidth="1" fill="white" fillOpacity="0.1" />
      <line x1="12.5" y1="11" x2="14" y2="11" stroke="#374151" strokeWidth="0.8" strokeLinecap="round" />
      <circle cx="30" cy="11" r="1.5" fill="#1E293B" />
      <circle cx="30.5" cy="10.5" r="0.5" fill="white" />
      <path d="M27 7.5 Q30 6.5 33 7.5" stroke="#78350F" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      ...
      <path
        ...
        fill="#78350F"
      />
      <path d="M27 21 Q30 23 34 21" stroke="#92400E" strokeWidth="1.2" fill="none" strokeLinecap="round" />
      <path d="M27.5 21.5 Q30 22.5 33.5 21.5" stroke="white" strokeWidth="0.7" fill="none" strokeLinecap="round" />
  ...
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      <g className={idle ? '' : 'burns-leg-back'}>
        ...
        <line x1="19" y1="44" x2="22" y2="50" stroke="#374151" strokeWidth="2.5" strokeLinecap="round" />
        <ellipse cx="23" cy="50.5" rx="3.5" ry="1.5" fill="#0F172A" />
      </g>
      <path d="M14 24 Q10 26 11 36 L30 36 L29 24 Q22 22 14 24Z" fill="#1E293B" />
      <path d="M14 24 Q12 18 16 16 Q20 14 22 16" fill="none" stroke="#1E293B" strokeWidth="5" strokeLinecap="round" />
      <path d="M19 24 L21 28 L23 24" fill="white" stroke="white" strokeWidth="0.5" />
      <line x1="21" y1="27" x2="21" y2="34" stroke="#0F172A" strokeWidth="1.2" strokeLinecap="round" />
      <rect x="10" y="33" width="4" height="2" rx="1" fill="white" opacity="0.8" />
      <g className={idle ? '' : 'burns-leg-front'}>
        <rect x="21" y="37" width="3" height="7" rx="1.5" fill="#0F172A" />
        <line x1="23" y1="43" x2="26" y2="50" stroke="#0F172A" strokeWidth="2.5" strokeLinecap="round" />
        <ellipse cx="27" cy="50.5" rx="3.5" ry="1.5" fill="#1E293B" />
      </g>
      <g className={idle ? '' : 'burns-arm-back'}>
        <line x1="16" y1="26" x2="10" y2="31" stroke="#374151" strokeWidth="2.2" strokeLinecap="round" />
        <line x1="10" y1="31" x2="8" y2="37" stroke="#374151" strokeWidth="2" strokeLinecap="round" />
        <circle cx="8" cy="37.5" r="1.6" fill="#D4A849" />
        <line x1="7" y1="36.5" x2="5.5" y2="35" stroke="#D4A849" strokeWidth="1.1" strokeLinecap="round" />
      </g>
      <g className={idle ? '' : 'burns-arm-front'}>
        <line x1="27" y1="26" x2="33" y2="30" stroke="#0F172A" strokeWidth="2.2" strokeLinecap="round" />
        <line x1="33" y1="30" x2="35" y2="36" stroke="#0F172A" strokeWidth="2" strokeLinecap="round" />
        <circle cx="35" cy="36.5" r="1.6" fill="#D4A849" />
        <line x1="36" y1="35.5" x2="37.5" y2="34" stroke="#D4A849" strokeWidth="1.1" strokeLinecap="round" />
      </g>
      <rect x="19" y="17" width="4" height="8" rx="2" fill="#D4A849" />
      <line x1="20" y1="17" x2="20" y2="24" stroke="#B8912A" strokeWidth="0.5" opacity="0.6" />
      <line x1="22" y1="17" x2="22" y2="24" stroke="#B8912A" strokeWidth="0.5" opacity="0.6" />
      <ellipse cx="25" cy="10" rx="9" ry="10" fill="#D4A849" />
      <path d="M16 8 Q14 5 15 2 Q16 1 16 4" stroke="#5C4A1E" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <path d="M17 7 Q14 3 16 0 Q17 0 17 3" stroke="#5C4A1E" strokeWidth="0.7" fill="none" strokeLinecap="round" />
      <path d="M18 7.5 Q17 4 18 1" stroke="#5C4A1E" strokeWidth="0.6" fill="none" strokeLinecap="round" opacity="0.7" />
      ...
      <path d="M27.5 8.5 Q30 7.5 33 9" stroke="#8B6914" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M27.5 11.5 Q30 12.5 33 11.5" stroke="#8B6914" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <path d="M27 6.5 Q30 5 33 6" stroke="#4A3510" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      <path d="M29 12 Q34 13 36 16 Q37 19 34 20" fill="none" stroke="#C49838" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M36 16 Q38.5 17 38 19 Q37 21 34 20" fill="#C49838" stroke="#B8912A" strokeWidth="0.5" />
      <circle cx="34.5" cy="19.5" r="0.8" fill="#B8912A" opacity="0.6" />
      <path d="M29 20.5 Q31 20 33 20.5 Q34 20.5 34.2 20" stroke="#8B5E3C" strokeWidth="1.1" fill="none" strokeLinecap="round" />
      <path d="M29.5 21.5 Q31.5 22.5 33.5 21.5" stroke="#8B5E3C" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <path d="M29 21 Q31.5 21.2 34 21" stroke="#6B4423" strokeWidth="0.9" fill="none" />
      <path d="M24 12 Q23 10 24 8" stroke="#B8912A" strokeWidth="0.5" fill="none" opacity="0.5" />
      <path d="M28 13 Q27 14 28 15" stroke="#B8912A" strokeWidth="0.5" fill="none" opacity="0.4" />
    </svg>
  )
}
  ...
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      ...
      <g className={idle ? '' : 'krusty-arm-back'}>
        <line x1="11" y1="24" x2="4" y2="33" stroke="#84CC16" strokeWidth="5" strokeLinecap="round" />
        <circle cx="4" cy="34" r="3.5" fill="#F9FAFB" />
      </g>
      <g className={idle ? '' : 'krusty-arm-front'}>
        <line x1="26" y1="23" x2="35" y2="30" stroke="#84CC16" strokeWidth="5" strokeLinecap="round" />
      ...
      <path d="M28.5 9 Q30.5 8 32.5 9.5" stroke="#374151" strokeWidth="1" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="14" r="3.5" fill="#EF4444" />
      <circle cx="33" cy="13" r="1" fill="#FCA5A5" opacity="0.6" />
      <path d="M31 17 Q34 21 31 20" stroke="#DC2626" strokeWidth="2.5" fill="#DC2626" strokeLinecap="round" />
      <path d="M28 17 Q30 15.5 33 17" stroke="#DC2626" strokeWidth="1.5" fill="#DC2626" strokeLinecap="round" />
  ...
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      <g className={idle ? '' : 'ralph-arm-back'}>
        <line x1="22" y1="28" x2="16" y2="34" stroke="#3B82F6" strokeWidth="4" strokeLinecap="round" />
        <line x1="16" y1="34" x2="13" y2="40" stroke="#FBBF24" strokeWidth="3" strokeLinecap="round" />
      </g>
      <g className={idle ? '' : 'ralph-leg-back'}>
        <line x1="24" y1="40" x2="18" y2="46" stroke="#3B82F6" strokeWidth="5" strokeLinecap="round" />
        <line x1="18" y1="46" x2="14" y2="52" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" />
        <ellipse cx="12" cy="52" rx="5" ry="2.5" fill="#7C3AED" />
      </g>
      <rect x="18" y="26" width="16" height="16" rx="4" fill="#3B82F6" />
      <path d="M22 26 Q24 29 26 26" stroke="#2563EB" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      ...
      <g className={idle ? '' : 'ralph-leg-front'}>
        <line x1="27" y1="42" x2="32" y2="47" stroke="#3B82F6" strokeWidth="5" strokeLinecap="round" />
        <line x1="32" y1="47" x2="36" y2="52" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" />
        <ellipse cx="38" cy="52" rx="5" ry="2.5" fill="#7C3AED" />
      </g>
      <g className={idle ? '' : 'ralph-arm-front'}>
        <line x1="30" y1="28" x2="36" y2="33" stroke="#3B82F6" strokeWidth="4" strokeLinecap="round" />
        <line x1="36" y1="33" x2="40" y2="38" stroke="#FBBF24" strokeWidth="3" strokeLinecap="round" />
      ...
      <path d="M29.5 10.5 Q33 9 36.5 10.5" stroke="#D97706" strokeWidth="2" fill="none" strokeLinecap="round" />
      ...
      <path d="M33 20 Q36 23 38.5 20" stroke="#8B4513" strokeWidth="1.5" fill="none" strokeLinecap="round" />
...
function MilhouseCharacter({ idle }: CharacterProps) {
  return (
    <svg width="48" height="52" viewBox="0 0 48 52" fill="none">
      ...
      <path d="M22 22 Q24 20 26 22" fill="white" stroke="white" strokeWidth="0.5" />
      ...
      <path d="M21 4 Q25 2 28 4" stroke="#60A5FA" strokeWidth="1" fill="none" strokeLinecap="round" />
      <path d="M24 3 Q26 0 28 3" fill="#3B82F6" stroke="#3B82F6" strokeWidth="0.5" />
      <ellipse cx="34" cy="14" rx="3.5" ry="2.5" fill="#F59E0B" />
      <circle cx="35" cy="13.5" r="1" fill="#FBBF24" />
      <line x1="24" y1="12" x2="27" y2="12" stroke="#64748B" strokeWidth="1.2" strokeLinecap="round" />
      <circle cx="22" cy="12" r="4" fill="none" stroke="#64748B" strokeWidth="1.5" />
      <circle cx="22" cy="12" r="3.5" fill="white" fillOpacity="0.25" />
      <circle cx="29" cy="12" r="4.5" fill="none" stroke="#64748B" strokeWidth="1.8" />
      <circle cx="29" cy="12" r="4" fill="white" fillOpacity="0.25" />
      <ellipse cx="27.5" cy="10.5" rx="1.2" ry="0.7" fill="white" fillOpacity="0.6" transform="rotate(-25 27.5 10.5)" />
      <ellipse cx="20.8" cy="10.8" rx="0.9" ry="0.5" fill="white" fillOpacity="0.5" transform="rotate(-20 20.8 10.8)" />
      <line x1="18" y1="12" x2="16" y2="13" stroke="#64748B" strokeWidth="1.2" strokeLinecap="round" />
      ...
      <path d="M20 8.5 Q22 7.5 24 8" stroke="#1E293B" strokeWidth="1" fill="none" strokeLinecap="round" />
      <path d="M27 8 Q29 7 31 7.5" stroke="#1E293B" strokeWidth="1" fill="none" strokeLinecap="round" />
      <path d="M27 17 Q29 16.5 31 17" stroke="#C0392B" strokeWidth="0.9" fill="none" strokeLinecap="round" />
      <path d="M28 17.8 Q29 18.2 30.5 17.8" stroke="#F59E0B" strokeWidth="0.6" fill="none" strokeLinecap="round" />
      <path d="M28 19 Q29 19.5 30 19" stroke="#F59E0B" strokeWidth="0.5" fill="none" strokeLinecap="round" />
      <path d="M22 23 L24 25 L26 23" fill="none" stroke="#EF4444" strokeWidth="0.8" />
    </svg>
  )
}
...
const LANE_COLORS = [
  { track: 'from-yellow-500/20 to-yellow-500/5', dot: 'bg-yellow-400', text: 'text-yellow-400' },    // Homer
  { track: 'from-red-500/20 to-red-500/5', dot: 'bg-red-400', text: 'text-red-400' },                // Bart
  { track: 'from-amber-500/20 to-amber-500/5', dot: 'bg-amber-400', text: 'text-amber-400' },        // Lisa
  { track: 'from-blue-500/20 to-blue-500/5', dot: 'bg-blue-400', text: 'text-blue-400' },             // Marge
  { track: 'from-sky-500/20 to-sky-500/5', dot: 'bg-sky-400', text: 'text-sky-400' },                 // Maggie
  { track: 'from-emerald-500/20 to-emerald-500/5', dot: 'bg-emerald-400', text: 'text-emerald-400' }, // Ned
  { track: 'from-slate-500/20 to-slate-500/5', dot: 'bg-slate-400', text: 'text-slate-400' },         // Burns
  { track: 'from-lime-500/20 to-lime-500/5', dot: 'bg-lime-400', text: 'text-lime-400' },             // Krusty
  { track: 'from-orange-500/20 to-orange-500/5', dot: 'bg-orange-400', text: 'text-orange-400' },     // Ralph
  { track: 'from-violet-500/20 to-violet-500/5', dot: 'bg-violet-400', text: 'text-violet-400' },     // Milhouse
]
...
export function RaceTrack({ members, sinceUnix }: RaceTrackProps) {
  ...
  const timeMarkers = useMemo(() => {
    ...
    if (markers[markers.length - 1]?.percent !== 100) {
      markers.push({
        label: nextDay8AM.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }),
        percent: 100,
      })
    }
    return markers
  ...
  return (
    <div className="space-y-2">
      ...
      {sorted.map((member, idx) => {
        ...
        const progress = getProgressPercent(member.lastActivityAt, sinceMs, endMs)

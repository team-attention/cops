        ...
        <CollapsibleContent>
          <div className="space-y-3 border-t border-zinc-800/50 p-3">
            ...
            <div>
              ...
              <ContentPanel
                className="max-h-32 max-w-full overflow-auto p-2"
                contentClassName="text-xs text-zinc-400"
              >
                {inputJson}
              </ContentPanel>
            </div>
            ...
            {toolResult && (
              <div>
                ...
                <div style={{ maxHeight: showFullOutput ? '400px' : '200px' }}>
                  <ContentPanel
                    variant={hasError ? 'error' : 'default'}
                    className="h-full overflow-auto p-2"
                    contentClassName={
                      hasError ? 'text-xs' : 'text-xs text-zinc-400'
                    }
                  >
                    {displayOutput}
                  </ContentPanel>

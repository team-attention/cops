...
export const ChatView = ({
  ...
  return (
    <Card className="group relative flex min-h-[400px] flex-col overflow-hidden border-zinc-800/50 bg-zinc-900/80 backdrop-blur-sm transition-all duration-300 hover:border-zinc-700/50">
      {/* Ambient glow */}

...
type GetProjectByIdAndOrgReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// project_id is the MongoDB ObjectID hex representation
	ProjectId string `protobuf:"bytes,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
...
func (x *GetProjectByIdAndOrgReq) Reset() {
	*x = GetProjectByIdAndOrgReq{}
	mi := &file_project_v1_project_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetProjectByIdAndOrgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetProjectByIdAndOrgReq) ProtoMessage() {}

func (x *GetProjectByIdAndOrgReq) ProtoReflect() protoreflect.Message {
	mi := &file_project_v1_project_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetProjectByIdAndOrgReq.ProtoReflect.Descriptor instead.
func (*GetProjectByIdAndOrgReq) Descriptor() ([]byte, []int) {
	return file_project_v1_project_proto_rawDescGZIP(), []int{2}
}

func (x *GetProjectByIdAndOrgReq) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *GetProjectByIdAndOrgReq) GetOrganizationId() string {
	if x != nil {
		return x.OrganizationId
	}
	return ""
...
type GetProjectByIdAndOrgRes struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetProjectByIdAndOrgRes) Reset() {
	*x = GetProjectByIdAndOrgRes{}
	mi := &file_project_v1_project_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetProjectByIdAndOrgRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetProjectByIdAndOrgRes) ProtoMessage() {}

func (x *GetProjectByIdAndOrgRes) ProtoReflect() protoreflect.Message {
	mi := &file_project_v1_project_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetProjectByIdAndOrgRes.ProtoReflect.Descriptor instead.
func (*GetProjectByIdAndOrgRes) Descriptor() ([]byte, []int) {
	return file_project_v1_project_proto_rawDescGZIP(), []int{3}
}

func (x *GetProjectByIdAndOrgRes) GetFound() bool {
	if x != nil {
		return x.Found
	}
	return false
...
func (x *GetProjectByIdAndOrgRes) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *GetProjectByIdAndOrgRes) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetProjectByIdAndOrgRes) GetOrganizationId() string {
	if x != nil {
		return x.OrganizationId
	}
	return ""
...
const file_project_v1_project_proto_rawDesc = "" +
	...
	"\x0forganization_id\x18\x05 \x01(\tR\x0eorganizationId\"a\n" +
	"\x17GetProjectByIdAndOrgReq\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\x12'\n" +
	"\x0forganization_id\x18\x02 \x01(\tR\x0eorganizationId\"\x8b\x01\n" +
	"\x17GetProjectByIdAndOrgRes\x12\x14\n" +
	"\x05found\x18\x01 \x01(\bR\x05found\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12'\n" +
	"\x0forganization_id\x18\x04 \x01(\tR\x0eorganizationId2\xc5\x01\n" +
	"\x0eProjectService\x12Q\n" +
	"\x0fRegisterProject\x12\x1e.project.v1.RegisterProjectReq\x1a\x1e.project.v1.RegisterProjectRes\x12`\n" +
	"\x14GetProjectByIdAndOrg\x12#.project.v1.GetProjectByIdAndOrgReq\x1a#.project.v1.GetProjectByIdAndOrgResB\xb0\x01\n" +
...
var file_project_v1_project_proto_goTypes = []any{
	...
	(*GetProjectByIdAndOrgReq)(nil), // 2: project.v1.GetProjectByIdAndOrgReq
	(*GetProjectByIdAndOrgRes)(nil), // 3: project.v1.GetProjectByIdAndOrgRes
}
var file_project_v1_project_proto_depIdxs = []int32{
	...
	2, // 1: project.v1.ProjectService.GetProjectByIdAndOrg:input_type -> project.v1.GetProjectByIdAndOrgReq
	1, // 2: project.v1.ProjectService.RegisterProject:output_type -> project.v1.RegisterProjectRes
	3, // 3: project.v1.ProjectService.GetProjectByIdAndOrg:output_type -> project.v1.GetProjectByIdAndOrgRes

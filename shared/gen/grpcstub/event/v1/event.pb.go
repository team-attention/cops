...
const file_event_v1_event_proto_rawDesc = "" +
	...
	"\x0fprocessed_count\x18\x03 \x01(\x05R\x0eprocessedCount2H\n" +
	"\fEventService\x128\n" +
...
var file_event_v1_event_proto_goTypes = []any{
	(*LogBatch)(nil),    // 0: event.v1.LogBatch
	(*SendLogsReq)(nil), // 1: event.v1.SendLogsReq
	(*SendLogsRes)(nil), // 2: event.v1.SendLogsRes
}
var file_event_v1_event_proto_depIdxs = []int32{
	0, // 0: event.v1.SendLogsReq.batch:type_name -> event.v1.LogBatch
	1, // 1: event.v1.EventService.SendLogs:input_type -> event.v1.SendLogsReq
	2, // 2: event.v1.EventService.SendLogs:output_type -> event.v1.SendLogsRes

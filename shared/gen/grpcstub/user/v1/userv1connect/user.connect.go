...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/team-attention/cops/shared/gen/grpcstub/user/v1"
	http "net/http"
	strings "strings"
)
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		getMe: connect.NewClient[v1.GetMeReq, v1.GetMeRes](
			httpClient,
...
func (c *userServiceClient) GetMe(ctx context.Context, req *connect.Request[v1.GetMeReq]) (*connect.Response[v1.GetMeRes], error) {

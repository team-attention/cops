...
.PHONY: deploy-all deploy-web deploy-api release tag _check-version
...
## release: Create git tag and build CLI/Daemon via GoReleaser
release: _check-version tag
	@echo "Building CLI and Daemon $(VERSION)..."
